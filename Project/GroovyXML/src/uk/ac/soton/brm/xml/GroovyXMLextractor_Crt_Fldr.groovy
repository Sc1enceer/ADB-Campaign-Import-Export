...
class GroovyXMLextractor_Crt_Fldr {
	...
	static void main(String[] args) {
		...
		* 	30/08/19
		...
		templateNames.each { template ->
			...
			//.println("Communication Template " + template)
		...
		/*
			creating folder in the xml file
			checks if the folder is up to date.
			Folder tag will NOT be created if term value is different to termStr
			Alvin Shi
			30/08/19
		 */
