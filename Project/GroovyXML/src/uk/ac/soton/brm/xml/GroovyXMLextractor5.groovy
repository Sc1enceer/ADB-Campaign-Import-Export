...
class GroovyXMLextractor5 {
	...
	//following tags will be ignored
	// watchlist
...
//TODO remove root org from exclude base
	...
	def static final campaign = "Admissions 2013/14 - Offer1"
	...
	//get the root node
	def static root = new XmlParser().parse(new File('sbox_full_exp_140113.xml')) //the XML file to parse
	...
	private void extractXML(){
		...
		//find the campaign
		def campaignXML = root."urn:Campaign".find { it."urn:Name"[0].text() == campaign }
